...
class OldOrderTransInfoPage extends StatefulWidget {

  OrderModel order_vo;
  String? code;

  OldOrderTransInfoPage({Key? key,required this.order_vo, this.code}):super(key:key);

  _OldOrderTransInfoPageState createState() => _OldOrderTransInfoPageState();
}


class _OldOrderTransInfoPageState extends State<OldOrderTransInfoPage> {
