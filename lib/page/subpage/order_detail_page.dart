...
class _OrderDetailPageState extends State<OrderDetailPage> {
  ...
  Future<void> goToAlloc() async {
    Map<String,dynamic> results = await Navigator.of(context).push(PageAnimationTransition(page: OrderTransInfoPage(order_vo: mData.value), pageAnimationType: LeftToRightTransition()));
  ...
  Future goToModifyOrder() async {
    Map<String,dynamic> results = await Navigator.of(context).push(PageAnimationTransition(page: OldRegistOrderPage(order_vo: mData.value, flag: "M"), pageAnimationType: LeftToRightTransition()));
