...
class OldOrderRequestInfoPage extends StatefulWidget {

  OrderModel order_vo;
  String? code;

  OldOrderRequestInfoPage({Key? key, required this.order_vo,this.code}):super(key:key);

  _OldOrderRequestInfoPageState createState() => _OldOrderRequestInfoPageState();
}

class _OldOrderRequestInfoPageState extends State<OldOrderRequestInfoPage> {
