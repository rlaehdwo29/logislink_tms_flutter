...
import 'package:logislink_tms_flutter/page/guide/smart_order_guide_page.dart';
...
import 'package:logislink_tms_flutter/page/subpage/regist_order_page.dart';
                                            ...
                                            if (tempRangeStart == null || tempRangeEnd == null) {
                                              ...
                                              if (tempRangeStart != null && tempRangeEnd == null) {
                                                ...
                                                if (startDiffDay > 0) {
                                                  ...
                                                  tempRangeEnd = tempRangeStart?.add(const Duration(days: 30));
                                                }
                                              } else {
                                     ...
                                     InkWell(
                                       onTap:() {
                                         Navigator.of(context).pushReplacement(
                                           MaterialPageRoute(builder: (_) => const SmartOrderGuidePage()),
                                         );
                                       },
                                       child: Container(
                                         ...
                                         child: Text(
                                             "사용방법",
                                             style:CustomStyle.CustomFont(styleFontSize14, Colors.white,font_weight: FontWeight.w400)
                                         )
                                       )
                                     ) : */const SizedBox()
                                                ]
                                      ...
                                      child: Row(
                                        children: [
                                          ...
                                          Expanded(
                                              ...
                                              child: InkWell(
                                                onTap: (){
                                                  Navigator.of(context).push(MaterialPageRoute(builder: (BuildContext context) => AppBarMyPage(call24Yn: api24Data.value["apiKey24"] != null && api24Data.value["apiKey24"] != '' ? "Y" : "N")));
                                                },
                                                  child: Container(
                                                  padding: EdgeInsets.symmetric(vertical: CustomStyle.getHeight(5)),
                                                    child: Row(
