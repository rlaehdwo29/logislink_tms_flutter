...
class RenewRegistOrderPage extends StatefulWidget {
  ...
  RenewRegistOrderPage({Key? key, this.order_vo, this.flag}):super(key:key);

  _RenewRegistOrderPageState createState() => _RenewRegistOrderPageState();
}

class _RenewRegistOrderPageState extends State<RenewRegistOrderPage> {
