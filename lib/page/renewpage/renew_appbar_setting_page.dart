...
class ReNewAppBarSettingPage extends StatefulWidget {
  _ReNewAppBarSettingPageState createState() => _ReNewAppBarSettingPageState();
}

class _ReNewAppBarSettingPageState extends State<ReNewAppBarSettingPage> {
