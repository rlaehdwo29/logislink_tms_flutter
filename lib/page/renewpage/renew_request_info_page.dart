...
class RenewRequestInfoPage extends StatefulWidget {
  OrderModel? order_vo;

  RenewRequestInfoPage({Key? key, this.order_vo}):super(key:key);

  _RenewRequestInfoPageState createState() => _RenewRequestInfoPageState();
}

class _RenewRequestInfoPageState extends State<RenewRequestInfoPage> {
