...
class _OldLoginPageState extends State<OldLoginPage> with CommonMainWidget {
  ...
  void goToMain() {
    Navigator.of(context).pushAndRemoveUntil(
        MaterialPageRoute(
            builder: (BuildContext context) => const OldMainPage()),
            (route) => false);
  }
                      ...
                      if (m_TermsCheck == false && m_TermsMode == TERMS.INSERT) {
                        ...
                        if (results != null && results.containsKey("code")) {
                          if (results["code"] == 200) {
                            Navigator.of(context).pushAndRemoveUntil(
                                MaterialPageRoute(
                                    builder: (BuildContext context) => const OldLoginPage()),
                                    (route) => false);
                          }
                        }
                      } else {
