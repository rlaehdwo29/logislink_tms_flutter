...
class TemplateModel extends ReturnMap {
  ...
  Map<String,dynamic> toJson() {
    return {
      ...
      "eLon" : eLon,
      "goodsName" : goodsName,
      "goodsWeight" : double.parse(goodsWeight??"0.0"),
      "weightUnitCode" : weightUnitCode,
      "weightUnitName" : weightUnitName,
      "goodsQty" : double.parse(goodsQty??"0.0"),
      ...
      "sellCharge" : int.parse(sellCharge??"0"),
      "sellFee" : int.parse(sellFee??"0"),
      "sellWeight" : sellWeight.toString(),
      "sellWayPointMemo" : sellWayPointMemo,
      "sellWayPointCharge" : int.parse(sellWayPointCharge??"0"),
      "sellStayMemo" : sellStayMemo,
      "sellStayCharge" : int.parse(sellStayCharge??"0"),
      "sellHandWorkMemo" : sellHandWorkMemo,
      "sellHandWorkCharge" : int.parse(sellHandWorkCharge??"0"),
      "sellRoundMemo" : sellRoundMemo,
      "sellRoundCharge" : int.parse(sellRoundCharge??"0"),
      "sellOtherAddMemo" : sellOtherAddMemo,
      "sellOtherAddCharge" : int.parse(sellOtherAddCharge??"0"),
      "custPayType" : custPayType,
      "buyCharge" : int.parse(buyCharge??"0"),
      "buyFee" : int.parse(buyFee??"0"),
      "wayPointMemo" : wayPointMemo,
      "wayPointCharge" : int.parse(wayPointCharge??"0"),
      "stayMemo" : stayMemo,
      "stayCharge" : int.parse(stayCharge??"0"),
      "handWorkMemo" : handWorkMemo,
      "handWorkCharge" : int.parse(handWorkCharge??"0"),
      "roundMemo" : roundMemo,
      "roundCharge" : int.parse(roundCharge??"0"),
      "otherAddMemo" : otherAddMemo,
      "otherAddCharge" : int.parse(otherAddCharge??"0"),
      "unitPrice" : unitPrice,
